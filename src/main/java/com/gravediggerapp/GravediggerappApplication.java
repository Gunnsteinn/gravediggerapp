package com.gravediggerapp;

import java.util.List;
import com.gravediggerapp.domain.Customer;
import com.gravediggerapp.repository.CustomerRepository;
...
public class GravediggerappApplication implements CommandLineRunner {

	@Autowired
	CustomerRepository customerRepository;

	public static void main(String[] args) {
		SpringApplication.run(GravediggerappApplication.class, args);
	}
